...
class Tournament(me.Document):
  ...
  no_bracket = me.BooleanField(required=True, default=False, db_field="noBracket")
  num_players = me.IntField(required=True, db_field="numPlayers")
  date = me.DateTimeField(required=True)
  date_added = me.DateTimeField(required=True, default=datetime.now, db_field="dateAdded")
  replay = me.URLField()
  results = me.ListField(me.EmbeddedDcoumentField(TournamentResult), required=True)
